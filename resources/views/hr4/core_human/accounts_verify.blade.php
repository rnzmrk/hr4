...
@section('title', 'Security Verification - Accounts')
            ...
            <div class="card shadow-sm mt-5">
                <div class="card-body p-4">
                    <div class="text-center mb-4">
                        ...
                        <h4 class="card-title fw-semibold">Accounts Security Verification</h4>
                        <p class="text-muted">Please verify your credentials to access Accounts Management</p>
                    </div>
                    ...
                    <form method="POST" action="{{ route('accounts.verify') }}">
                        @csrf

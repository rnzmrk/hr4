...
@section('title', 'Security Verification - Salary Computation')
            ...
            <div class="card shadow-sm mt-5">
                <div class="card-body p-4">
                    <div class="text-center mb-4">
                        ...
                        <h4 class="card-title fw-semibold">Salary Computation Security Verification</h4>
                        <p class="text-muted">Please verify your credentials to access Salary Computation</p>
                    </div>
                    ...
                    <form method="POST" action="{{ route('payroll.salary-computation.verify') }}">
                        @csrf

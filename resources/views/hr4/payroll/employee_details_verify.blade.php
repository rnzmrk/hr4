...
@section('title', 'Security Verification - Employee Details')
            ...
            <div class="card shadow-sm mt-5">
                <div class="card-body p-4">
                    <div class="text-center mb-4">
                        ...
                        <h4 class="card-title fw-semibold">Employee Details Security Verification</h4>
                        <p class="text-muted">Please verify your credentials to access Employee Details</p>
                    </div>
                    ...
                    <form method="POST" action="{{ route('payroll.employee-details.verify') }}">
                        @csrf

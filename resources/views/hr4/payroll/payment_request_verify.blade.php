...
@section('title', 'Security Verification - Payment Request')
            ...
            <div class="card shadow-sm mt-5">
                <div class="card-body p-4">
                    <div class="text-center mb-4">
                        ...
                        <h4 class="card-title fw-semibold">Payment Request Security Verification</h4>
                        <p class="text-muted">Please verify your credentials to access Payment Request</p>
                    </div>
                    ...
                    <form method="POST" action="{{ route('payroll.payment-requests.verify') }}">
                        @csrf

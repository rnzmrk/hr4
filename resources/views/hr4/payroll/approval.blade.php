    ...
    <div class="alert alert-info alert-dismissible fade show" role="alert">
        <div class="d-flex align-items-center">
            ...
            <div class="flex-grow-1">
                <strong>Security Verified</strong> - You have been granted access to Budget Request Management
                @if(session('budget_request_verified_at'))
                    <br><small class="text-muted">Verified at: {{ session('budget_request_verified_at')->format('g:i A, M j, Y') }}</small>
                @endif
            </div>
            <form method="POST" action="{{ route('payroll.budget-requests.clear_verification') }}" class="d-inline">
                @csrf

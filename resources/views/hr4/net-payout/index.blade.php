    ...
    <div class="alert alert-secondary alert-dismissible fade show" role="alert">
        <div class="d-flex align-items-center">
            ...
            <div class="flex-grow-1">
                <strong>Security Verified</strong> - You have been granted access to Net Payout Management
                @if(session('net_payout_verified_at'))
                    <br><small class="text-muted">Verified at: {{ session('net_payout_verified_at')->format('g:i A, M j, Y') }}</small>
                @endif
            </div>
            <form method="POST" action="{{ route('net-payout.clear_verification') }}" class="d-inline">
                @csrf
